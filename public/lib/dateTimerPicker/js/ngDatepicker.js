...
.directive('ngDatepicker', ['$document', function ($document) {
    ...
    return {
        ...
        template: '<div class="input-group" ng-focus="showCalendar()"> <input type="text" ng-focus="showCalendar()" ng-value="viewValue" class="form-control input-sm ng-datepicker-input" placeholder="{{ placeholder }}" name="{{ name }}" required>' +
            '<label class="input-group-addon" for="testdate" ng-focus="showCalendar()"> <span class="fa fa-calendar"></span> </label></div>' +
            //		'<div><input type="text" ng-focus="showCalendar()" ng-value="viewValue" class="form-control input-sm ng-datepicker-input" placeholder="{{ placeholder }}" name="{{ name }}" required></div>' +
